	...
	<nav class="navbar navbar-inverse navbar-fixed-top">
		<div class="container">
			<div class="navbar-header">
				...
				<h1 style="color: white;margin-top: 10px;" id="myhead">The Buzzed Brain</h1>
			</div>
					...
					<div class="slider-content">
						...
						<div class="text">      <!-- jquery typed effect -->
							...
							<div class="social-networks">
								...
								<a href="https://twitter.com/yashikasen3" class="fa fa-twitter"></a>
								<a href="https://www.instagram.com/artist_istree" class="fa fa-instagram"></a>
								
								<a href="https://www.linkedin.com/in/yashika-sen-28622616b/" class="fa fa-linkedin"></a>
         	...
         	<div class="row">
         		<div class="col-xs-12">
         			<div class="section-title text-center">
         				<h2><b>SERVICES</b></h2>
         				<p>
         					These are our services provided to you <br> Look what you need in the treasure!!!
         				</p>
         			</div>
         		</div>
         	</div>
         	<div class="row">
         		...
         		<div class="col-md-4 col-sm-6 col-xs-12">
         			<div class="service-wrap text-center">
         				...
         				<p>
         					Here you will find all the video tutorials related to programming languages 
         					like JAVA,PYTHON,ANDROID, etc.
         				</p>
         			</div>
         		</div>
...
<!-- 
 ...
 -->
			...
			<section class="work" id="work"><br>
				...
				<p class="text-center">Join us to improve your work and contribute to programming world</p>
		...
		<section class="header7 cid-rjrjygOfd1" id="header7-3">
			...
			<div class="container text-center" id="our-members">
				<h2><b>MEMBERS</b></h2>
				<p>
					You can contact anytime <br> it would be a pleasure to solve your queries.
				</p>
			</div>
						...
						<div id="team-memebers" class="owl-carousel owl-theme">
							<div class="team-member text-center">
								...
								<div class="team-member-info text-center">
									<h4 class="team-member-name">Yashika Sen</h4>
									<h4 class="team-member-designation">Developer</h4>
									<ul class="social-list">
										<li><a href="https://www.instagram.com/artist_istree" class="social-icon icon-gray"><i class="fa fa-instagram"></i></a></li>
										<li><a href="https://twitter.com/yashikasen3" class="social-icon icon-gray"><i class="fa fa-twitter"></i></a></li>
							...
							<?php } ?>
								...
								<div class="panel panel-default">
									...
									<div id="collapseTwo" class="panel-collapse collapse" aria-labelledby="headingTwo">
										<div class="panel-body">
											<p>
												The Buzzed Brain is an online E-learning website <br>
